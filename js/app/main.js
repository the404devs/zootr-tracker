define(["require", "jquery", "data/ages", "data/abilities", "data/locations", "data/regions", "data/itemsAndSongs", "data/itemChecks", "classes/inventory", "classes/itemCheck", "data/settings", "data/items"], function(require, $, Age, Abilities, Locations, Regions, Items, ItemChecks, Inventory, ItemCheck, Settings) {
            ...
            locations.forEach(function(locationName) {
                ...
                if (Items['BIG_KEY_' + locationName] || Items['SMALL_KEY_' + locationName]) {
                    ...
                    if (Items['BIG_KEY_' + locationName]) {
                        keys.append(
                            $('<div/>').addClass('item').attr('data-item', 'BIG_KEY_' + locationName).attr('data-original-item', 'BIG_KEY_' + locationName).append($('<img/>').attr('src', 'images/BIG_KEY.png'))
                        );
                    }
                    if (Items['SMALL_KEY_' + locationName]) {
                        keys.append(
                            $('<div/>').addClass('item').attr('data-item', 'SMALL_KEY_' + locationName).attr('data-original-item', 'SMALL_KEY_' + locationName).append($('<img/>').attr('src', 'images/SMALL_KEY.png')).append($('<span/>').addClass('count'))
                        );
                    }
                }
                keys.append(
                    $('<div/>').addClass('item').addClass('map').attr('data-item', 'MAP_' + locationName).append($('<img/>').attr('src', 'images/MAP_ICON.png'))
                );
                header.append(keys);
    ...
    var ItemTracker = function() {
        ...
        this.check = function(e) {
            var $box = $(e.target),
                $check = $(e.target).closest('.item-check');
        ...
        this.recordPedestalHint = function(e) {
            var button = $(e.target).closest('.pedestal-hint'),
                dungeonItems = {};
